...
class Toastr
{
    ...
    {
        return '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/wisiva/toastr@' . $version . '/dist/css/wisiva-toastr.min.css">';
    }
    ...
    {
        return '<script src="https://cdn.jsdelivr.net/gh/wisiva/toastr@' . $version . '/dist/js/wisiva-toastr.min.js"></script>';
    }
